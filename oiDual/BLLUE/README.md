...
`╔══════════╗
║ KOBLLUX v13 · LINKS OFICIAIS ║
║ BASE: https://www.infodose.com.br/oiDual/BLLUE ║
╚══════════╝`
...
```copy
<!-- THEME PRINCIPAL -->
<link rel="stylesheet" href="https://www.infodose.com.br/oiDual/BLLUE/css/theme.kobllux.css">
```

---

```copy 
<!-- THEME FULL 44 CLASSES -->
...
```copy
<!-- ARQUÉTIPOS CORE -->
<script src="https://www.infodose.com.br/oiDual/BLLUE/json/archetypes_kobllux.core.json"></script>
```

---

```copy
<!-- ARQUÉTIPOS COMPLETO 44 -->
<script src="https://www.infodose.com.br/oiDual/BLLUE/json/kobllux_archetypes.json"></script>
```
