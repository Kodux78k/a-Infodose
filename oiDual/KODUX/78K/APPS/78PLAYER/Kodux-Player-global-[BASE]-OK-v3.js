...
/* ═══════════════════════════════════════════════════════
   GLOBAL PLAYER · ICON + UTF-8 FALLBACK
   ═══════════════════════════════════════════════════════ */

#global-player .gp-toolbar {
  position: absolute;
  top: 12px;
  right: 12px;
  z-index: 20;
...
#global-player .gp-btn:hover {
  background: rgba(255,255,255,.16);
  transform: scale(1.05);
}

#global-player .gp-btn.expand:hover {
  background: color-mix(
    in srgb,
    var(--active-color, #8b5cf6) 40%,
    transparent
  );
}

#global-player .gp-btn.close:hover {
...
/* ─────────────────────────────────────────────────────
   UTF-8 FALLBACK
   Fica por baixo do Lucide.
   Se o SVG existir, ele cobre visualmente o símbolo.
   ───────────────────────────────────────────────────── */

#global-player .gp-fallback {
  position: absolute;
...
/* Quando o Lucide foi convertido para SVG,
   esconde visualmente o fallback. */

#global-player .gp-btn svg.gp-lucide {
  position: relative;
  z-index: 2;
}

#global-player .gp-btn svg.gp-lucide + .gp-fallback {
  z-index: 1;
}
 ...
 <div id="global-player" class="v-glass session-window overflow-hidden">
  ...
  <div class="gp-toolbar">
    ...
    <button
      ...
      <i data-lucide="minus" class="gp-lucide"></i>
      <span class="gp-fallback" aria-hidden="true">−</span>
    ...
    <button
      ...
      <i data-lucide="maximize-2" class="gp-lucide"></i>
      <span class="gp-fallback" aria-hidden="true">⤢</span>
    ...
    <button
      ...
      <i data-lucide="x" class="gp-lucide"></i>
      <span class="gp-fallback" aria-hidden="true">✕</span>
  ...
  <div
    id="player-frame-wrap"
    class="gp-frame w-full h-full bg-black">
  </div>
