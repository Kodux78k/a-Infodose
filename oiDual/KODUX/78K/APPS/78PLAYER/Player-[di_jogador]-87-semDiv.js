...
})(`<html><head><meta name="viewport" content="width=device-width, initial-scale=1, maximun-scale=1, viewport-fit=cover, user-scalable=no">
 ...
 <script>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display:none;">
    ...
    <symbol id="kx-vinyl" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-12.5c-2.49 0-4.5 2.01-4.5 4.5s2.01 4.5 4.5 4.5 4.5-2.01 4.5-4.5-2.01-4.5-4.5-4.5zm0 7c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"></path>
    </symbol>
    ...
    <symbol id="kx-prev" viewBox="0 0 24 24" fill="currentColor">
      <path d="M19 18.5L10.5 12 19 5.5v13zM9 5.5v13H5v-13h4z"></path>
    </symbol>
    <symbol id="kx-next" viewBox="0 0 24 24" fill="currentColor">
      <path d="M5 5.5l8.5 6.5L5 18.5v-13zM19 5.5v13h-4v-13h4z"></path>
    </symbol>
    ...
    <symbol id="kx-bolt" viewBox="0 0 24 24" fill="currentColor">
      <path d="M13 2L4 14h6l-3 8 9-12h-6l3-8z"></path>
    </symbol>
    <symbol id="kx-collapse-full" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 15.5L4 7.5l2-2 6 6 6-6 2 2z"></path>
    </symbol>
    <symbol id="kx-link" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 6v2.5l-2.5 2.5-2.5-2.5V6c0-2.5 2-4.5 4.5-4.5S16 3.5 16 6v2.5l-2.5 2.5-2.5-2.5V6zM12 18v-2.5l2.5-2.5 2.5 2.5V18c0 2.5-2 4.5-4.5 4.5S7 20.5 7 18v-2.5l2.5-2.5 2.5 2.5V18z"></path>
    </symbol>
    <symbol id="kx-plus" viewBox="0 0 24 24" fill="currentColor">
      <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
    </symbol>
    <symbol id="kx-folder" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4 20h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-7l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2z"></path>
    </symbol>
    <symbol id="kx-folder-add" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4 20h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-7l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2zm4-4h2v2h4v-2h2v-4h-2v-2h-4v2H8v4z"></path>
    </symbol>
    ...
    <symbol id="kx-playlist" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4 6h16v2H4V6zm0 5h10v2H4v-2zm0 5h6v2H4v-2zm13-3.5l6 4.5-6 4.5v-9z"></path>
    </symbol>
    ...
    <symbol id="kx-waveform" viewBox="0 0 24 24" fill="currentColor">
      <path d="M3 12h2v12H3zm4-4h2v16H7zm4-4h2v20h-2zm4 4h2v16h-2zm4 4h2v12h-2z"></path>
    </symbol>
