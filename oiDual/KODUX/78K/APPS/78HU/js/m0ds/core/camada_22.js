...
function __resize_OLD(){ const r=arc.getBoundingClientRect(); W=Math.floor(r.width); H=Math.floor(r.height);
...
function __draw_OLD(){ ctx.clearRect(0,0,W,H); const m=Math.min(W,H);
