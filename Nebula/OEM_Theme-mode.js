...
<head>
    ...
    <title>FRACTAL 369 · compacto</title>
    <style>
        /* ─── reset + base ─── */
        * {
            margin: 0;
        ...
        .panel.collapsed .panel-header .chevron {
        ...
        .play-dock {
            ...
            padding: 4px 10px env(safe-area-inset-bottom, 4px) 10px;
            display: flex;
            align-items: center;
            gap: 6px;
            z-index: 20;
        ...
        .play-dock .controls .btn.playing {
            color: var(--cyan);
        }
        ...
        .play-dock input[type="range"]::-webkit-slider-thumb {
            appearance: none;
            width: 10px;
            height: 10px;
            border-radius: 50%;
        ...
        .toast {
            ...
            font-size: 12px;
            color: var(--text);
            animation: fadeToast 2.4s forwards;
            pointer-events: none;
        }
        @keyframes fadeToast {
            0% {
        ...
        /* ─── TEMA CLARO (Apple Light via data-theme) ─── */
        [data-theme="light"] {
            --bg: #f5f5f7;
        ...
        [data-theme="light"] .fractal-block {
            background: rgba(0, 0, 0, 0.04);
        }
        [data-theme="light"] #view-full {
            background: rgba(0, 0, 0, 0.04);
            color: #1a1a1e;
        }
        [data-theme="light"] .play-dock {
            background: rgba(255, 255, 255, 0.92);
        ...
        [data-theme="light"] .s-chip {
            background: rgba(0, 0, 0, 0.04);
            color: rgba(0, 0, 0, 0.5);
        }
        [data-theme="light"] .s-chip:hover {
            border-color: #007aff;
            color: #1a1a1e;
        }
        ...
        [data-theme="light"] .arch-pill.selected {
            color: #007aff;
            border-color: #007aff;
...
<body>
    ...
    <header class="topbar">
        ...
        <div class="badge">
            <span class="dot"></span>
            <span id="arch-badge" style="font-weight:600;">◈ KOBLLUX</span>
        </div>
        <div class="badge" style="margin-left:6px;cursor:pointer;" onclick="toggleTheme()" title="Alternar tema">
