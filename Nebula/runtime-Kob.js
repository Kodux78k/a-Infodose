...
<html lang="pt-BR" data-arch="" data-user="" data-opcode="0x00" data-camada="METΔ0"><head>
  <!-- ══════════════════════════════════════════════════════════
       BLOCO: META
       TIPO: meta
       GRUPO: meta
  ...
  ══════════════════════════════════════════════════════════ -->
  <link data-k-id="L_1" data-k-group="css-core" data-k-toggle="on" href="https://www.infodose.com.br/css/main.css" rel="stylesheet">
  ...
  ══════════════════════════════════════════════════════════ -->
  <script data-k-id="JS_1" data-k-group="boot" data-k-toggle="on" type="module" src="https://www.infodose.com.br/JESUS_VERBO_INBOX/bootKoduxs.js"></script>
...
<div id="nebula">
  ...
  ══════════════════════════════════════════════════════════ -->
  <script data-k-id="JS_3" data-k-group="core" data-k-toggle="on" src="https://www.infodose.com.br/js/kobDivX.js"></script>
  <!-- ══════════════════════════════════════════════════════════
  ...
  ══════════════════════════════════════════════════════════ -->
  <script data-k-id="JS_6" data-k-group="data" data-k-toggle="on" type="module" src="https://www.infodose.com.br/js/modules/kob-Fetchh.js"></script>
  <!-- ══════════════════════════════════════════════════════════
