...
<body class="field-closed mode-night">
 ...
 <div class="section" style="height:100vh, overflow-y:auto">
 <div class="top-bar">
...
<iframe
  src="https://www.infodose.com.br/oiDual/KODUX/78K/APPS/78KH/a%E2%82%AC78KoS.html"
...
<style> body{min-height:100vh; height:100%;overflow:auto;} 
</style>
...
<script type="module">
    import 'https://www.infodose.com.br/js/modules/78K_eliza.js';
  </script>

<script type="module">
    import 'https://www.infodose.com.br/js/modules/Kmotor.js';
  </script>
...
<script type="module">
    import 'https://www.infodose.com.br/js/kxt-insert.js';
  </script> 

 
<script type="module">
    import 'https://www.infodose.com.br/js/DH0-insert.js';
  </script>

<script type="module">
    import 'https://www.infodose.com.br/js/oiDual-ParTKlz.js';
  </script> 
...
<script type="module">
    import 'https://www.infodose.com.br/js/oiDual--Y-insert.js';
  </script> 
-->

<style>
    @import 'https://www.infodose.com.br/css/main.css';
 .section{ min-height:100vh; overflow-y:auto}
 </style>
