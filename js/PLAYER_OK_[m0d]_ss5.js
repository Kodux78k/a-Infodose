...
/* FUSION BLADE: Transmuted HTML (PLAYER_OK_[m0d]_ss5.html) */
(function() {
    console.log('[Fusion] Injecting PLAYER_OK_[m0d]_ss5.html...');
    const container = document.createElement('div');
    container.id = 'mod_dnv0t';
    container.setAttribute('data-source', 'PLAYER_OK_[m0d]_ss5.html');
